<template>
	<div class="workPanel">
        ...
        <div class="btn-group pull-right">
          <button id="preorderRefreshLabors" type="button" class="btn btn-sm btn-warning" @click="uploadWorks" style="display: none;">Обновить</button>
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-responsive order-table" v-if="list != '' && !updateWork || typical != '' && !updateWork">
          <thead>
            <tr>
  ...
  components: {
    ...
    delTypical(id) {
      this.$parent.$emit('delAllTypical', id)
		...
		delLabot(id) {
      this.$parent.$emit('delLabotPreOrder', id)
		},
    delAllLabor() {
